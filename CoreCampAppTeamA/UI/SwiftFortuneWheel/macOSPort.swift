...
import Foundation
    ...
    func UIGraphicsPushContext(_ content: CGContext) {
        ...
        let nscg = NSGraphicsContext(cgContext: content, flipped: true)
    ...
    extension NSImage {
        ...
        func draw(at position: NSPoint) {
            draw(at: position, from: NSRect(x: 0, y: 0, width: size.width, height: size.height), operation: .copy, fraction: 1)
        }
    }
#endif
    ...
    extension NSImageView {
        var tintColor: NSColor? {
            ...
            set {
                ...
                image = image?.tint(color: tintColor)
            }
        }
    }
#endif
    ...
    extension NSButton {
        ...
        var isUserInteractionEnabled: Bool {
            ...
            set {
                isEnabled = newValue
                (cell as? NSButtonCell)?.imageDimsWhenDisabled = newValue
            }
        }
    }
#endif
    ...
    extension CGRect {
        func inset(by margins: NSEdgeInsets) -> CGRect {
            ...
            return insetBy(dx: margins.left, dy: margins.top)
        }
    }
#endif
